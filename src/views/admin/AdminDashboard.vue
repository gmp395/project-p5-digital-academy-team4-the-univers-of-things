  ...
  <div class="featured-management -mt-10 px-6">
    ...
    <div class="mb-10">
      ...
      <p class="text-slate-400">
        Welcome back, <span class="font-semibold text-white">{{ authStore.user?.name }}</span> 👋
      </p>

      <p class="mt-1 text-slate-500">
        Manage users and featured characters from one place.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 mb-10">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="material-symbols-outlined text-3xl text-yellow-400">
            stars
          </span>
        </div>
